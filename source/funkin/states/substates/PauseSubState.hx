...
import funkin.data.Metadata.MetadataFile;
...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		if (meta != null)
		{
			if (meta.credits.music != null) createCornerText("Song: " + meta.credits.music.join(', '), true);
			if (meta.credits.chart != null) createCornerText("Chart: " + meta.credits.chart.join(', '), true);
			if (meta.credits.art != null) createCornerText("Art: " + meta.credits.art.join(', '), true);
			if (meta.credits.code != null) createCornerText("Code: " + meta.credits.code.join(', '), true);
			if (meta.credits.va != null) createCornerText("Voice Acting: " + meta.credits.va.join(', '), true);
		}
		...
		if (controls.ACCEPT #if mobile || _virtualpad.buttonA.justPressed #end)
		{
			...
			switch (daSelected)
			{
				...
				case "Exit to menu":
					...
					FlxG.switchState(() -> PlayState.isStoryMode ? new WeeklyMainMenuState() : new FreeplayState());
